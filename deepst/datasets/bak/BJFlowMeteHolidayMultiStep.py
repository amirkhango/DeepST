...
def load_data(T=48, nb_flow=2, len_closeness=None, len_period=None, len_trend=None, len_test=None, preprocess_name='preprocessing.pkl', multistep=4):
    ...
    for year in xrange(13, 17):
        fname = os.path.join(
            DATAPATH, 'BJ', 'BJ{}_M32_T30_Flow.h5'.format(year))
...
def load_data_nomissing(T=48, nb_flow=2, len_closeness=None, len_period=None, len_trend=None, len_test=None, preprocess_name='preprocessing.pkl'):
    ...
    for year in xrange(13, 17):
        fname = os.path.join(
            DATAPATH, 'BJ', 'BJ{}_M32_T30_Flow_nomissing.h5'.format(year))
        print("file name: ", fname)
        stat(fname)
        data, timestamps = load_stdata(fname)
        # print(timestamps)
